...
import { 
  ...
  LogOut, Sparkles, CalendarOff, LayoutDashboard, UserCircle, MessageSquare, Workflow, Calculator, Code, Package, HelpCircle, Radar, ScanLine, Zap, TrendingUp, ClipboardList
} from "lucide-react";
...
type TabType = "home" | "calendar" | "widgets" | "clients" | "conversations" | "pipeline" | "accounting" | "products" | "inventory" | "staff" | "services" | "time-off" | "stats" | "settings" | "support" | "retention" | "pixel" | "analytics";
