...
export const OwnYourClientsSection = () => {
  return (
    <section className="relative py-24 md:py-32 overflow-hidden" style={{ backgroundColor: "#1A1A2E" }}>
      {/* Subtle radial glow */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[600px] rounded-full opacity-[0.07]" style={{ background: "radial-gradient(circle, #B87D5E 0%, transparent 70%)" }} />
      </div>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-14">
          ...
          <motion.div
            ...
            style={{
              ...
              boxShadow: "0 0 60px -20px rgba(184,125,94,0.15)",
            }}
            initial={{ opacity: 0, x: 40 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true, margin: "-50px" }}
